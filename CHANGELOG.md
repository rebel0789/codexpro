...
- Prioritized Git-changed files within bounded analysis inventories and suppressed docs-only path-risk noise so change review spends its budget on the touched execution path.
